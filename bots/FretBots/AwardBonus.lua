...
function AwardBonus:GetValue(bot, award)
	...
	-- CDS-PATCH: Dire-side compensation. TEAM_DIRE == 3.
	if Settings.direScale ~= nil and Settings.direScale ~= 1 and bot.stats.team == 3 then
		clamped = clamped * Settings.direScale
	end
...
function AwardBonus:GetSpecificPerMinuteBonus(bot, pmBot, roleTable, settings)
	...
	-- CDS-PATCH: Dire-side compensation. TEAM_DIRE == 3.
	if Settings.direScale ~= nil and Settings.direScale ~= 1 and bot.stats.team == 3 then
		bonus = bonus * Settings.direScale
	end
