...
-- CDS-PATCH: multiplier applied to Dire bot bonuses only, to offset the Dire side
-- historically underperforming Radiant. 1.0 = off. See Customize/general.lua.
local DireBonusScale     = Customize.Dire_Bonus_Scale               or  1.0   -- [1,  2]
...
function IsTimeToVoteForAllyBonusScale()
	...
	-- CDS-PATCH: published here so AwardBonus can apply it per-bot.
	Settings.direScale = DireBonusScale
